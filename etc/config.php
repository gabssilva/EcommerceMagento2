...
return [
    'modules' => [
        ...
        'Jumpers_Attribute' => 1,
        'Jumpers_AttributeSet' => 1,
        'Jumpers_CategoryAldeiaTech' => 1,
        'Jumpers_CategorySoRaiva' => 1,
        'Jumpers_Payment' => 1,
        'Jumpers_Checkout' => 1,
        'Jumpers_ProductAldeiaTech' => 1,
        'Jumpers_ProductSoRaiva' => 1,
        'Jumpers_ProductSoRaivaDownloadable' => 1,
        'Jumpers_StoreView' => 1,
        'Klarna_Core' => 1,
